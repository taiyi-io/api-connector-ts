...
addAddressPool(mode: InterfaceMode, description?: string): Promise<BackendResult>
...
addExternalAddressRange(poolID: string, begin: string, end: string): Promise<BackendResult>
addInternalAddressRange(poolID: string, begin: string, end: string): Promise<BackendResult>
removeExternalAddressRange(poolID: string, begin: string, end: string): Promise<BackendResult>
