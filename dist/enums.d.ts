export declare enum controlCommandEnum {
    ...
    QueryGuestTraffic = "query_guest_traffic",
    ...
    CreateGuestProfile = "create_guest_profile",
    ModifyGuestProfile = "modify_guest_profile",
    DeleteGuestProfile = "delete_guest_profile",
    GetGuestProfile = "get_guest_profile",
    QueryGuestProfiles = "query_guest_profiles",
    CreateGuestFromProfile = "create_guest_from_profile",
...
export declare enum VolumeFormat {
    Raw = "raw",
    Qcow = "qcow2"
}
...
export declare const NODE_RESOURCE_SNAPSHOT_FIELD_COUNT = 21;
export declare const POOL_RESOURCE_SNAPSHOT_FIELD_COUNT = 24;
...
export declare enum TokenSigningMethod {
    HS256 = "HS256",
    HS384 = "HS384",
    HS512 = "HS512",
    RS256 = "RS256",
