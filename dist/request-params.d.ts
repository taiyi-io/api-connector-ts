...
export interface ControlCommandRequest {
    ...
    modify_guest_traffic_quota?: {
        guest_id: string;
        quota: import('./data-defines').TrafficQuotaSpec;
    };
    extend_guest_traffic_temp?: {
        guest_id: string;
        extra_bytes: number;
    };
